...
static VALUE graphicsPosX(VALUE self){
	return INT2FIX(shState->graphics().x());
}

static VALUE graphicsPosY(VALUE self){
...
static VALUE graphicsWait(int argc, VALUE *argv, VALUE self){
	int duration;
...
static VALUE graphicsSetVsync(int argc, VALUE *argv, VALUE self){
	int vsync;
	rb_get_args(argc, argv, "i", &vsync RB_ARG_END);
	shState->graphics().setVsync(vsync);
	return Qnil;
}

static VALUE graphicsFadeout(int argc, VALUE *argv, VALUE self){
	int duration;
	rb_get_args(argc, argv, "i", &duration RB_ARG_END);
...
static VALUE graphicsFadein(int argc, VALUE *argv, VALUE self){
	int duration;
	rb_get_args(argc, argv, "i", &duration RB_ARG_END);
...
static VALUE graphicsResizeScreen(int argc, VALUE *argv, VALUE self){
	int width, height;
...
static VALUE graphicsMoveScreen(int argc, VALUE *argv, VALUE self){
	int x, y;
